...
plot(ysww,cnKsww*sswwb,'m-' ,'linewidth',2.00,'displayname','SWW convection');
plot(ysww,prKsww*sswwb,'r-' ,'linewidth',2.00,'displayname','SWW production');
plot(ysww,pdKsww*sswwb,'g-' ,'linewidth',2.00,'displayname','SWW pres diff');
plot(ysww,tdKsww*sswwb,'c-' ,'linewidth',2.00,'displayname','SWW turb diff');
plot(ysww,vdKsww*sswwb,'k-' ,'linewidth',2.00,'displayname','SWW visc diff');
plot(ysww,epKsww*sswwb,'b-' ,'linewidth',2.00,'displayname','SWW dissipation');
%
plot(yrww,cnKrww*srwwb,'m--','linewidth',2.00,'displayname','RWW convection');
plot(yrww,prKrww*srwwb,'r--','linewidth',2.00,'displayname','RWW production');
plot(yrww,pdKrww*srwwb,'g--','linewidth',2.00,'displayname','RWW pres diff');
plot(yrww,tdKrww*srwwb,'c--','linewidth',2.00,'displayname','RWW turb diff');
plot(yrww,vdKrww*srwwb,'k--','linewidth',2.00,'displayname','RWW visc diff');
plot(yrww,epKrww*srwwb,'b--','linewidth',2.00,'displayname','RWW dissipation');
%------------------------------
...
plot(ysww,tkKsww     *sswwrs,'k-' ,'linewidth',2.00,'displayname',['SWW $$0.5\eta_{ii}$$']);
plot(ysww, tksww(:,1)*sswwrs,'r-' ,'linewidth',2.00,'displayname',['SWW $$\eta_{11}$$']);
plot(ysww, tksww(:,2)*sswwrs,'g-' ,'linewidth',2.00,'displayname',['SWW $$\eta_{22}$$']);
plot(ysww, tksww(:,3)*sswwrs,'b-' ,'linewidth',2.00,'displayname',['SWW $$\eta_{33}$$']);
%
plot(yrww,tkKrww     *srwwrs,'k--' ,'linewidth',2.00,'displayname',['RWW $$0.5\eta_{ii}$$']);
plot(yrww, tkrww(:,1)*srwwrs,'r--' ,'linewidth',2.00,'displayname',['RWW $$\eta_{11}$$']);
plot(yrww, tkrww(:,2)*srwwrs,'g--' ,'linewidth',2.00,'displayname',['RWW $$\eta_{22}$$']);
plot(yrww, tkrww(:,3)*srwwrs,'b--' ,'linewidth',2.00,'displayname',['RWW $$\eta_{33}$$']);
%------------------------------
figname=[cname,'-','rs'];
saveas(fig,figname,'jpeg');
end
