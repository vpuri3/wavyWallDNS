...
c     if(mod(istep,10).eq.0) call e2_out
c     
c     call budgets_incomp_avg(tSTATFREQ,tSTATSTART,readSTAT)
      ...
      idir_sctr = 2  ! u-plus data wrt wall normal dir (Y)
      idir_line = 2  ! average over plane normal to dir
      idir_plnr = 3  ! avg over dir to get planar data
      idir_geom = 1  ! avg over geom features in dir
...
!..   (Ref.: http://elib.dlr.de/31857/1/94-Maass.pdf)
      ...
      yStartDomain = 0.0
      yEndDomain   = domainHeight ! ( delta + domainHeight )
