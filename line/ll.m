...
%plot(ypchan,tkKchan*schanrs,'r-' ,'linewidth',2.00,'displayname','Chan TKE');
plot(ypchan,imKchan*schanb ,'r--','linewidth',2.00,'displayname','Chan TKE Imb');
%
%plot(ypsww,tkKsww*sswwrs,'k-' ,'linewidth',2.00,'displayname','SWW TKE');
plot(ypsww,imKsww*sswwb ,'k--','linewidth',2.00,'displayname','SWW TKE Imb');
%
%pause;
%plot(yprww,tkKrww*srwwrs,'b-' ,'linewidth',2.00,'displayname','RWW TKE');
plot(yprww,imKrww*srwwb ,'b--','linewidth',2.00,'displayname','RWW TKE Imb');
%------------------------------
